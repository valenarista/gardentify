...
type HeightRegistrationCardPlantIconProps = {
  plantUuid: Plant['uuid'];
};

const HeightRegistrationCardPlantIcon: React.FC<HeightRegistrationCardPlantIconProps> = (props) => {
...
export default HeightRegistrationCardPlantIcon;
